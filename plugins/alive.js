...
❏ *Bio Bot* : ${ppstatus.status}\n\n*Support/Follow Me*\nhttps://instagram.com/johannes28_`, quoted: m, sendEphemeral: true, thumbnail: fs.readFileSync('./src/error.png'), contextInfo: { forwardingScore: 999, isForwarded: true, mentionedJid: [global.conn.user.jid]}})
}
