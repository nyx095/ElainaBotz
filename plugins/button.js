...
_*FOLLOW ME*_
*http://instagram.com/johannes28_*

_*JOIN MY GROUP*_
_*https://tinyurl.com/yjenm6ka*_

_*MY REST API*_
_*https://api-johannes.herokuapp.com*_
...
`.trim(), 'Ayane Shirakawa By Johannes', `LIST MENU`, `.allmenu`, `OWNER BOT`, `.owner`, `INFO BOT`, `#alive`)
